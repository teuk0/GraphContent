...
public class DutchStemmer extends SnowballStemmer 
{
    ...
    private final Among a_0[] = { new Among("", -1, 6, "", this), new Among("\u00E1", 0, 1, "", this), new Among("\u00E4", 0, 1, "", this),
        new Among("\u00E9", 0, 2, "", this), new Among("\u00EB", 0, 2, "", this), new Among("\u00ED", 0, 3, "", this),
        new Among("\u00EF", 0, 3, "", this), new Among("\u00F3", 0, 4, "", this), new Among("\u00F6", 0, 4, "", this),
        new Among("\u00FA", 0, 5, "", this), new Among("\u00FC", 0, 5, "", this) };

    private final Among a_1[] = { new Among("", -1, 3, "", this), new Among("I", 0, 2, "", this), new Among("Y", 0, 1, "", this) };

    private final Among a_2[] = { new Among("dd", -1, -1, "", this), new Among("kk", -1, -1, "", this), new Among("tt", -1, -1, "", this) };

    private final Among a_3[] = { new Among("ene", -1, 2, "", this), new Among("se", -1, 3, "", this), new Among("en", -1, 2, "", this),
        new Among("heden", 2, 1, "", this), new Among("s", -1, 3, "", this) };

    private final Among a_4[] = { new Among("end", -1, 1, "", this), new Among("ig", -1, 2, "", this), new Among("ing", -1, 1, "", this),
        new Among("lijk", -1, 3, "", this), new Among("baar", -1, 4, "", this), new Among("bar", -1, 5, "", this) };

    private final Among a_5[] = { new Among("aa", -1, -1, "", this), new Among("ee", -1, -1, "", this), new Among("oo", -1, -1, "", this),
